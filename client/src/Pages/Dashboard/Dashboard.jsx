...
const Dashboard = () => {
  ...
  const fetchdata = async () => {
    const response = await axios.get(`http://localhost:4000/api/v1/project/pichart`, {
      headers: {
  ...
  const fetchbudget = async () => {
    const response = await axios.get(`http://localhost:4000/api/v1/project/pichartbudget`, {
      headers: {
        Authorization: `Bearer ${localStorage.getItem('auth')}`
      }
    })
      ...
      <section className="grid md:grid-cols-2 xl:grid-cols-4 gap-6">
        ...
        <div className="flex items-center p-8 bg-white shadow rounded-lg">
          ...
          <div>
            ...
            <span className="block text-gray-500">COst Hike</span>
          </div>
        </div>
        <div className="flex items-center p-8 bg-white shadow rounded-lg">
          <div className="inline-flex flex-shrink-0 items-center justify-center h-16 w-16 text-blue-600 bg-blue-100 rounded-full mr-6">
          ...
          <div>
            ...
            <span className="block text-gray-500">Payment Done</span>
          </div>
        </div>
      </section>
      <section className="grid md:grid-cols-2 xl:grid-cols-4 xl:grid-rows-3 xl:grid-flow-col gap-6">
        ...
        <div className="flex items-center p-8 bg-white shadow rounded-lg">
          ...
          <div>
            ...
            <span className="block text-gray-500">Projects Completed</span>
          </div>
        </div>
        <div className="flex items-center p-8 bg-white shadow rounded-lg">
          ...
          <div className="overflow-y-auto" style={{maxHeight: '24rem'}}>
            <ul className="p-6 space-y-6">
              <li className="flex items-center">
                ...
                <span className="text-gray-600">Hall Tiling</span>
                <span className="ml-auto font-semibold">1000</span>
              </li>
              <li className="flex items-center">
                <div className="h-10 w-10 mr-3 bg-gray-100 rounded-full overflow-hidden">
                  <img src="https://randomuser.me/api/portraits/men/81.jpg" alt="Calvin Steward profile picture" />
                </div>
                <span className="text-gray-600">Hall Wiring</span>
                <span className="ml-auto font-semibold">1500</span>
              </li>
        ...
        <main className="p-6 sm:p-10 space-y-6">
          ...
          <section className="grid md:grid-cols-2 xl:grid-cols-4 gap-6">
            <div className="flex items-center p-8 bg-white shadow rounded-lg">
              ...
              <div>
                <span className="block text-2xl font-bold">{data.totalProject}</span>
            ...
            <div className="flex items-center p-8 bg-white shadow rounded-lg">
              ...
              <div>
                <span className="block text-2xl font-bold">{data.totalProjectsCompleted}</span>
                <span className="block text-gray-500">Completed</span>
              </div>
            </div>
            <div className="flex items-center p-8 bg-white shadow rounded-lg">
              ...
              <div>
                <span className="block text-2xl font-bold">{data.totalProjectsIncomplete}</span>
                <span className="block text-gray-500">Incomplete</span>
              </div>
            </div>
            <div className="flex items-center p-8 bg-white shadow rounded-lg">
              <div className="inline-flex flex-shrink-0 items-center justify-center h-16 w-16 text-red-600 bg-red-100 rounded-full mr-6">
              ...
              <div>
                <span className="inline-block text-2xl font-bold">{Math.round(data.averageProjectsCompleted)}</span>
                <span className="block text-gray-500">Average Completed</span>
              </div>
            </div>
            <div className="flex items-center p-8 bg-white shadow rounded-lg">
              <div className="inline-flex flex-shrink-0 items-center justify-center h-16 w-16 text-blue-600 bg-blue-100 rounded-full mr-6">
              ...
              <div>
                <span className="block text-2xl font-bold">{Math.round(data.averageProjectsCompleted)}</span>
                <span className="block text-gray-500">Average InCompleted</span>
              </div>
            </div>
          </section>
          <section className="grid md:grid-cols-2 xl:grid-cols-4 xl:grid-rows-3 xl:grid-flow-col gap-6">
            <div className="flex flex-col md:col-span-2 md:row-span-2 bg-white shadow rounded-lg">
              ...
              <div className="p-4 flex-grow">
                {/* <div className="flex items-center justify-center h-full px-4 py-16 text-gray-400 text-3xl font-semibold bg-gray-100 border-2 border-gray-200 border-dashed rounded-md">Chart</div> */}
                {
                  activePieChart === '/pichart' ? <Piechart api={'/pichart'} /> :
            ...
            <div className="flex items-center p-8 bg-white shadow rounded-lg">
              ...
              <div>
                <span className="block text-2xl font-bold">{Math.round(budget.averageBudget)}</span>
                <span className="block text-gray-500">Average Budget</span>
              </div>
            </div>
            <div className="flex items-center p-8 bg-white shadow rounded-lg">
              <div className="inline-flex flex-shrink-0 items-center justify-center h-16 w-16 text-teal-600 bg-teal-100 rounded-full mr-6">
              ...
              <div>
                <span className="block text-2xl font-bold">{Math.round(budget.totalBudget)}</span>
                <span className="block text-gray-500">Total Budget</span>
              </div>
            </div>
            <div className="row-span-3 bg-white shadow rounded-lg">
              <div className="flex items-center justify-between px-6 py-5 font-semibold border-b border-gray-100">
...
>>>>>>> 23ff3939db1c8b864cfacc83f9b8d3b5a660e294
