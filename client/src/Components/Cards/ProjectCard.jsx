...
const ProjectCard = ({ projectId, projTitle, custNo, custEmail, onClick, totalBudget, totalTasks, totalRooms, img, percentage }) => {

    const navigate = useNavigate()
    return (
        
      <div onClick={() => navigate(`/project/${projectId}`)} className="antialiased font-sans ">
      <div className="">
        <div className="flex items-center justify-center">
          <div className="py-6 px-3 w-80">
            <div className="bg-white shadow-xl rounded-lg overflow-hidden">
              ...
              <div className="p-4">
                <p className="uppercase tracking-wide text-sm font-bold text-gray-700">{projTitle} - ₹{totalBudget}</p>
              ...
              <div className="flex p-4 border-t border-gray-300 text-gray-700">
                <div className="flex-1 inline-flex items-center">
                  ...
                  <p><span className="text-gray-900 font-bold">{totalRooms}</span> Rooms</p>
                </div>
                <div className="flex-1 inline-flex items-center">
                  <svg className="h-6 w-6 text-gray-600 fill-current mr-3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                  ...
                  <p><span className="text-gray-900 font-bold">{totalTasks}</span> Tasks</p>
                </div>
              </div>
