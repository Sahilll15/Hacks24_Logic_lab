...
const Workcard = ({ RoomName, Contractors, percentage }) => {
    return (
        <div className='flex '>
            <div className="relative flex justify-between w-[95%] h-52 rounded-xl bg-white bg-clip-border text-gray-700 shadow-md items-center">
                <div className='flex'>
                ...
                <div>
                    <div className="p-6">
                        ...
                        <p className="block font-sans text-base font-light leading-relaxed text-inherit antialiased">
                            {Contractors || "No contractor assigned"}
                        </p>
                        <button
                ...
                <div className="p-6 pt-0 flex">
                    <div className="relative pt-1 ">
                        <div className="flex mb-2 items-center justify-between w-52 mr-1">
                            <div>
